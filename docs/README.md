...
Deep dive into architecture and advanced topics:
...
- **GitHub Issues** — [report a bug or request a feature](https://github.com/OpenJarbas/simple_NER/issues)
...
- **PyPI** — https://pypi.org/project/simple_NER/
